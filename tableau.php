 ...
 */
    ...
    echo ("<div class=\"row\">");
        foreach ($listes as $index => $liste){
            ...
            echo ("<div class=\"col-xs-2 color1\">");
            ...
            foreach ($cartes as $carte){
                ...
                echo ("<div class=\"row\">");
                echo ("<div class=\"col-xs-10 col-xs-offset-1 color2\">");
                // croix de suppression
                echo ("<a class=\"pull-right\" href=\"main.php?page=remcard.php&cardid=".$carte->getId()."\" >X</a>");
                echo ("<p>Carte : <a href=\"javascript:void(0)\" onclick=\"document.getElementById('light_car".$carte->getId()."').style.display='block';document.getElementById('fade').style.display='block'\"> [ -> ]</a></p>");
                ?>
                ...
                <?php
                echo ("<a href=\"javascript:void(0)\" onclick=\"document.getElementById('light_com".$carte->getId()."').style.display='block';document.getElementById('fade').style.display='block'\"><p>".$carte->getContenu()."</p>");
